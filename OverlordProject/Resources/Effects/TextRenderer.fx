...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
	...
	texCoord.x = vertex[0].Position.x / gTextureSize.x;
	texCoord.y = vertex[0].Position.y / gTextureSize.y;
	...
	texCoord.x = vertexPosition.x / gTextureSize.x;
	texCoord.y = vertexPosition.y / gTextureSize.y;
